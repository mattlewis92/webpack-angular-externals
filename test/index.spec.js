...
const webpackAngularExternals = require('../src');

const fixturesDir = 'fixtures';
const fixtures = fs.readdirSync(path.join(__dirname, fixturesDir));

describe('webpack-angular-externals', () => {
  it('should mark angular imports as external', () => {
      ...
      return new Promise((resolve, reject) => {
        try {
          const config = {
            ...
            externals: webpackAngularExternals()
          };
